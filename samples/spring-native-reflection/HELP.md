...
* The original package name 'com.example.spring-native-reflection' is invalid and this project uses 'com.example.springnativereflection' instead.
...
```
$ docker run --rm spring-native-reflection:0.0.1-SNAPSHOT
```
