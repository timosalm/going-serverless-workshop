...
* The original package name 'com.example.spring-native-accessing-resources' is invalid and this project uses 'com.example.springnativeaccessingresources' instead.
...
```
$ docker run --rm spring-native-accessing-resources:0.0.1-SNAPSHOT
```
