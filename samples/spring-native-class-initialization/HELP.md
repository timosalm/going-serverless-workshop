...
* The original package name 'com.example.spring-native-class-initialization' is invalid and this project uses 'com.example.springnativeclassinitialization' instead.
...
```
$ docker run --rm spring-native-class-initialization:0.0.1-SNAPSHOT
```
